...
def test_incident_request_accepts_valid_payload() -> None:
    """Verify that a complete incident request payload is accepted."""
...
def test_incident_request_rejects_short_title() -> None:
    """Verify that very short incident titles are rejected."""
...
def test_incident_request_rejects_short_description() -> None:
    """Verify that very short incident descriptions are rejected."""
...
def test_incident_request_uses_api_as_default_source_channel() -> None:
    """Verify that the default source channel is API when none is provided."""
